...
class TracksPickerView: UIView
{
    ...
    override func draw(_ rect: CGRect) {
        ...
        addButton.frame = CGRect(x: 3, y: 3, width: 20, height: 20)
        ...
        closeButton.frame = CGRect(x:Int(rect.width) - (20 + 3), y: 3, width: 20, height: 20)
...
extension TracksPickerView: UIPickerViewDataSource, UIPickerViewDelegate {
